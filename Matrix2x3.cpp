...
void Matrix2x3::SetAsRotate(float radians)
{
...
Matrix2x3 Matrix2x3::CreateRotationMatrix(float angle)
{
	return Matrix2x3( Vector2f{ cos( angle ), sin( angle ) }, Vector2f{ -sin( angle ), cos( angle ) }, Vector2f{} );
}
